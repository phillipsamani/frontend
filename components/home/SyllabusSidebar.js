...
const items = [
  getItem('All Syllabuses', '1', <PieChartOutlined />),
  
  getItem('PPY Syllabus', '3', <ContainerOutlined />),
  getItem('Primary Syllabuses', 'sub1', <MailOutlined />, [
    getItem(<Link href="/syllabus/[slug]" as="/syllabus/primary-science-syllabus" ><a>Science</a></Link>, '5'),
    getItem(<Link href="/syllabus/[slug]" as="/syllabus/primary-social-studies-syllabus" ><a>Social Studies </a></Link>, '6'),
